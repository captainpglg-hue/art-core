      ...
      <header className="fixed top-0 left-0 right-0 z-40 h-16 bg-[#0C0C0C]/80 backdrop-blur-md border-b border-white/5">
        <div className="max-w-screen-2xl mx-auto h-full px-4 lg:px-8 flex items-center gap-6">
          ...
          <nav className="hidden md:flex items-center gap-0.5 ml-2">
            ...
            <Link href="/pass-core/certifier" className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs text-white/40 hover:text-white/70 hover:bg-white/5 transition-all">
              <ShieldCheck className="size-3.5" />PASS-CORE
            </Link>
            <Link href="/prime-core/dashboard" className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs text-white/40 hover:text-white/70 hover:bg-white/5 transition-all">
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-30 pt-16 md:hidden">
          ...
          <nav className="relative bg-[#111111] border-b border-white/8 px-4 py-4 space-y-1">
            ...
            <Link href="/pass-core/certifier" className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm text-white/70 hover:text-white hover:bg-white/5 transition-all" onClick={() => setMobileOpen(false)}>
              <ShieldCheck className="size-4 text-gold/70" />PASS-CORE
            </Link>
            <Link href="/prime-core/dashboard" className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm text-white/70 hover:text-white hover:bg-white/5 transition-all" onClick={() => setMobileOpen(false)}>
