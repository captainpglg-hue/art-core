...
CREATE TYPE IF NOT EXISTS artwork_status AS ENUM (
  'draft',
  'pending_cert',
  'certified',
  'listed',
...
CREATE TYPE IF NOT EXISTS bet_status AS ENUM (
  'active',
  'winning',
  'outbid',
  'won',
...
CREATE TYPE IF NOT EXISTS auction_status AS ENUM (
  'scheduled',
  'live',
  'ended',
  'cancelled'
...
CREATE INDEX IF NOT EXISTS idx_artworks_fts ON public.artworks
