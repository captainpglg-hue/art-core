...
CREATE TABLE IF NOT EXISTS public.artworks (
  ...
  -- Full-text search vector (populated by trigger — GENERATED ALWAYS AS n'est pas immutable avec regconfig)
...
-- Trigger pour peupler search_vector (évite 42P17 lié à GENERATED ALWAYS AS + regconfig)
