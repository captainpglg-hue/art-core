      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-30 pt-16 md:hidden">
          ...
          <nav className="relative bg-[#111111] border-b border-white/8 px-4 py-4 space-y-1">
            ...
            <a href={`${PRIME_CORE_URL}/prime-core/dashboard`} target="_blank" rel="noopener" className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm text-white/70 hover:text-white hover:bg-white/5 transition-all">
