...
// Jumeau de art-core/lib/sql-translator.ts (même mécanique dupliquée).
//
// ⚠️ Mécanique fragile derrière les bugs « filtre ignoré silencieusement ».
//    Toute évolution DOIT être couverte par lib/__tests__/sql-translator.test.ts.
// ============================================================================
