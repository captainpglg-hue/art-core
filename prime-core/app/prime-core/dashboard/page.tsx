import { getMarkets, getTotalBetsCount } from "@/lib/db";
          ...
          <Link key={market.id} href={`/prime-core/market/${market.id}`}
            ...
            <div className="p-4 space-y-3">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center gap-2">
                  <div className="flex-1 h-6 rounded-lg overflow-hidden flex">
                    <div className="bg-green-500/20 flex items-center justify-center" style={{ width: `${(Number(market.total_yes_amount) / Math.max(Number(market.total_yes_amount) + Number(market.total_no_amount), 1)) * 100}%` }}>
              ...
              <div className="flex items-center justify-between text-[11px]">
                ...
                <span className="text-white/30">{Number(market.total_yes_amount) + Number(market.total_no_amount)} pts misés</span>
