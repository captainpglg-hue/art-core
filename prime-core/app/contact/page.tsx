...
export default function ContactPage() {
  ...
  return (
    <main className="max-w-2xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold text-white mb-2">Nous contacter</h1>
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-lg focus:border-[#D4AF37]/40 focus:outline-none text-white"
            />
          </div>
          <div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="px-5 py-2.5 bg-[#D4AF37] text-[#0A1128] font-semibold rounded-lg hover:opacity-90 disabled:opacity-50"
        >
