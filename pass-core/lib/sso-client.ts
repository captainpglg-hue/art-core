// ============================================================================
// lib/sso-client.ts — pass-core en « partie » (relying party) du SSO
// ----------------------------------------------------------------------------
// art-core est le fournisseur d'identité (IdP). pass-core redirige vers l'IdP
// (/auth/sso/start → IdP /auth/sso/authorize), reçoit un code sur
// /auth/sso/callback, l'échange serveur→serveur contre le token de session,
// puis pose son propre cookie core_session (host-only).
//
// Helpers PURS (URL + state) testés unitairement. Le secret partagé n'est lu
// que côté route serveur (callback), jamais ici.
// ============================================================================
...
export const SSO_CLIENT = "pass-core";
