  ...
  return (
    <footer className="mt-20 border-t border-white/10 bg-black/40">
      <div className="max-w-screen-xl mx-auto px-4 lg:px-8 py-10 grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
        <div>
          <h4 className="text-[#D4AF37] font-semibold mb-3">PASS-CORE</h4>
          <p className="text-white/50 text-xs leading-relaxed">
            Certification blockchain pour œuvres d&apos;art.
          </p>
        </div>
        <div>
          <h4 className="text-white/70 font-medium mb-3">Produit</h4>
          <ul className="space-y-2 text-white/50">
            <li><Link href="/pass-core/certifier" className="hover:text-white">Certifier</Link></li>
            <li><Link href="/pass-core/verifier" className="hover:text-white">Vérifier</Link></li>
            <li><Link href="/pass-core/gallery" className="hover:text-white">Galerie</Link></li>
      ...
      <div className="border-t border-white/5 py-4 text-center text-white/30 text-xs">
        © {year} PASS-CORE — Écosystème core
      </div>
    </footer>
  );
}
