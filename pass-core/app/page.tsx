      ...
      <section className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="max-w-lg text-center">
          ...
          <h1 className="font-display text-3xl md:text-4xl font-semibold text-white leading-tight mb-4">
            Certifiez votre oeuvre.<br />
            <span className="text-[#C9A84C]">Vendez-la plus cher.</span>
          </h1>
          <p className="text-white/50 text-base mb-8">
            Les oeuvres certifiees se vendent en moyenne <span className="text-[#C9A84C] font-semibold">40% plus cher</span> sur ART-CORE
          </p>
          ...
          <Link href="/pass-core/certifier"
            ...
            Certifier mon oeuvre maintenant <ArrowRight className="size-5" />
          </Link>

          {/* 3 benefits */}
          <div className="mt-10 space-y-3 text-left max-w-sm mx-auto">
            {[
              { icon: Award, text: "Badge certifie visible sur votre fiche", color: "text-green-400", bg: "bg-green-500/10" },
              { icon: TrendingUp, text: "Prix de vente valorise automatiquement", color: "text-[#C9A84C]", bg: "bg-[#C9A84C]/10" },
              { icon: Lock, text: "Protection contre la copie et la contrefacon", color: "text-blue-400", bg: "bg-blue-500/10" },
            ].map((b) => (
