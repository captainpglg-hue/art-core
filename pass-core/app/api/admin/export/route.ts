...
export async function GET(req: NextRequest) {
  ...
  // TODO: validate admin role properly (cf. pass-core/CLAUDE.md)
  ...
  const usersSql = `SELECT u.id, u.email, u.full_name as name, u.username, u.role, u.points_balance, u.total_earned, u.is_initie, u.created_at,
  ...
  // bug fix: schéma Supabase utilise full_name, pas name
