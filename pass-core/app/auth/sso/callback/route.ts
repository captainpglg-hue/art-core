// Destination : pass-core/app/auth/sso/callback/route.ts
// Retour du handoff SSO : valide le state (nonce vs cookie), échange le code
// contre le token de session via l'IdP (serveur→serveur, secret partagé), pose
// le cookie core_session (host-only) et redirige vers la cible interne.
