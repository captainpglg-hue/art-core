    ...
    <div className="max-w-screen-xl mx-auto px-4 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
        {artworks.map((a) => {
          ...
          return (
            <a key={a.id} href={`http://localhost:3000/art-core/oeuvre/${a.id}`} className="group block rounded-2xl overflow-hidden bg-navy-200 border border-white/5 hover:border-gold-DEFAULT/20 transition-all">
